...
def argparser():
    ...
    parser.add_argument(
        '--train_file',
        type=str,
        default='D:/transpoter binding/data/sequence_base/transport_train_newnoscale.csv',
        help='Directory for input data.'
    )
    parser.add_argument(
        '--test_file',
        type=str,
        default='D:/transpoter binding/data/sequence_base/transport_test_newnoscale.csv',
        help='Directory for input data.'
    )
    parser.add_argument(
